...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert '/login/' in self.browser.current_url, "Не та страница"
    ...
    def register_new_user(self, email, password):
        ...
        register_password_replay = self.browser.find_element(*LoginPageLocators.REGISTER_PASSWORD_REPLAY)
        register_password_replay.send_keys(password)
